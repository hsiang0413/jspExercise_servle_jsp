...
<tr bgcolor='tan' >
    ...
    <input id='num' name="mId" value="${param.mId}" type="text" size="14" style="text-align:left" >
    <div style="color:#FF0000; font-size:60%; display: inline">${ErrorMsg.id}</div>
</tr>
<tr bgcolor='tan' >
    <td width="120" height="40">密碼:</td>
    <td width="600" height="40" align="left" >
    <input id='num' name="pswd" value="${param.pswd}" type="password" size="14" style="text-align:left" >
